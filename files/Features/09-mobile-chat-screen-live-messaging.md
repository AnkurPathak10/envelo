...
- Bubble metadata reserves fixed figure-space width before its bottom-right timestamp/receipt. This leaves a deliberate visual gap after both sent and received text, while retaining the compact single-line layout and the timestamp/receipt's lower-right anchor.
